Algoritmo OrdenarNumeros
	...
	FinSi
    Si num3 > num4 Entonces temp = num3; num3 = num4; num4 = temp; FinSi
    Si num3 > num5 Entonces temp = num3; num3 = num5; num5 = temp; FinSi
    Si num4 > num5 Entonces temp = num4; num4 = num5; num5 = temp; FinSi
